...
<script type="text/javascript">
	function submit() {
		...
		//普通提交
		post("../saveArticle.do",{"details":details,"title":"测试标题","userId":"3"});
...
<div class="container">
  <div class="header">
    <h1><a href="#">
      <img src="" alt="Z.Blog!" name="logo" width="20%" height="90" id="logo"  />
    </a></h1> 
    <!-- end .header --></div>
  <div class="sidebar1">
    <ul class="nav">
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
  <dic id="article_title" ></dic>
  <div id="epiceditor" style='height: auto; min-height: 500px;'></div>
  <div class="btn btn-default" onclick="submit()">提交</button>
    <!-- end .content --></div>
  <div class="footer">
    <p>@copyleft</p>
    <!-- end .footer --></div>
